	...
	if(isset($_POST['submit'])){
		...
		if($realusername && $password){										
			...
			if ($check_user == 0) {
				...
				$query = mysqli_query($db_connect, "INSERT INTO users (`user_id`, `firstname`, `lastname`, `username`, `password`, `accounttype`,`email`) VALUES (NULL, '$firstname', '$lastname', '$realusername', '$password', '$usertype','$email')");
